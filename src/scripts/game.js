...
const checkEndGame = () => {
  ...
  credits.setAttribute("href", "https://bit.ly/eliseofotos");
  ...
  if (disabledCards.length === 20) {
    ...
    setTimeout(() => {
      ...
      modalEndGameTitle.innerHTML = `<span>Felicidades </span><span>${localStorage.getItem(
        "player"
      )} </span><span>tu ganas en ${FinishTime}s</span>`;
